...
Auf der Registerkarte _[!UICONTROL Active]_werden Ihre Amazon-Auflistungen angezeigt, die auf [!DNL Amazon Marketplace] aktiv sind und mit einem Produkt in Ihrem [!DNL Commerce]-Katalog übereinstimmen.
...
- **[!UICONTROL Edit Assigned ASIN]**: Wählen Sie die Änderung des Ihrem Katalogprodukt zugewiesenen ASIN aus. Verwenden Sie diese Aktion, wenn ein Produkt in Ihrem Katalog mit dem falschen ASIN abgeglichen wurde. Siehe [Zugewiesene ASIN bearbeiten](./edit-assigned-asin.md).
