...
![Registerkarte &quot;Überschreibung&quot;](assets/amazon-overrides.png){width="600" zoomable="yes"}
...
| [!UICONTROL Action] | Liste der verfügbaren Aktionen, die auf eine bestimmte Liste angewendet werden können. So wenden Sie eine Aktion an: im _[!UICONTROL Action]_Spalte, klicken **[!UICONTROL Select]**und wählen Sie eine Option:<ul><li>[[!UICONTROL Edit Overrides]](./creating-editing-overrides.md#edit-override-single-listing)</li><li>[[!UICONTROL View Details]](./product-listing-details.md)</li></ul> |
