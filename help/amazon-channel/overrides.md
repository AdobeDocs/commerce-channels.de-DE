...
| [!UICONTROL Condition Override] | Die neue Bedingung, die in der Überschreibung definiert wird. Wenn die auf die Auflistung angewendete Überschreibung keine Bedingungsüberschreibungen ist, wird in dieser Spalte `Not Selected` angezeigt. |
...
| [!UICONTROL Action] | Liste der verfügbaren Aktionen, die auf eine bestimmte Liste angewendet werden können. Um eine Aktion anzuwenden, klicken Sie in der Spalte _[!UICONTROL Action]_auf **[!UICONTROL Select]**und wählen Sie eine Option:<ul><li>[[!UICONTROL Edit Overrides]](./creating-editing-overrides.md#edit-override-single-listing)</li><li>[[!UICONTROL View Details]](./product-listing-details.md)</li></ul> |
