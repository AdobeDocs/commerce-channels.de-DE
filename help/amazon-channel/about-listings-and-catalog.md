...
Die gesamte Synchronisierung wird von einer [Cron-Auftrag](https://docs.magento.com/user-guide/system/cron.html){target="_blank"}festgelegt ist, wird in der [Aufgaben vor der Einrichtung](./amazon-pre-setup-tasks.md).
