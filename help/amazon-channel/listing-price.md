...
1. Für **[!UICONTROL Magento Price Source]** (erforderlich), wählen Sie eine Option.
...
1. Für **[!UICONTROL Minimum Advertised Price (MAP)**], wählen Sie eine Option.
...
1. Für **[!UICONTROL Strike Through Price (MSRP)]**, wählen Sie eine Option.
...
1. Für **Anwendung der Mehrwertsteuer (MwSt.)** eine Option auswählen:
...
1. **(Nur UK Stores)** Für **[!UICONTROL Amazon Product Tax Code (PTC)]** eine Option auswählen:
   ...
   - `Set Default PTC` - Entscheiden Sie, ob Sie einen universellen Produktsteuercode (PTC) haben, den Sie für alle Ihre Produkte verwenden möchten. Bei Auswahl dieser Option müssen Sie _[!UICONTROL Default PTC]_.
...
1. Für **[!UICONTROL Currency Conversion]**, wählen Sie eine Option.
...
![Listingpreis](assets/amazon-listing-price.png){width="500" zoomable="yes"}

| Feld | Beschreibung |
|---------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [!UICONTROL Magento Price Source] | Bestimmt die Preisquelle, die bei der Erstellung Ihrer Amazon-Listen verwendet wird. Der Standardwert ist `Price`. Wenn Sie ein anderes Attribut auswählen, z. B. `Amazon Price` oder `Special Price`festgelegt ist, wird der definierte Wert für das Attribut für Ihre Amazon-Auflistung verwendet. Wenn das ausgewählte Attribut jedoch nicht definiert ist, `Price` verwendet. |
